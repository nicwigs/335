...
private:
	...
	///True when want to see mouse movement
	bool mShowHistory = false;

	bool mFeedMinionsActive = false; ///< Set true when we are giving bananas

	bool mGiveMinionPotionActive = false; ///< Set true when we are giving potion
