...
public:
	...
	void virtual SetActor(CActor * actor) override;
	void virtual SetTimeline(CTimeline * timeline) override;
	void virtual SetKeyframe() override;
	void virtual GetKeyframe() override;
	void virtual DeleteKeyframe() override;
...
private:
	...
	/// The animation channel for animating the position of the head
