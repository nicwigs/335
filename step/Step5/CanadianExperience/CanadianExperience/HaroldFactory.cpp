...
std::shared_ptr<CActor> CHaroldFactory::Create()
{
	...
	headt->SetRightEyeCenter(Point(70, 85));
	headt->SetLeftEyeCenter(Point(40, 85));
	headt->SetRightEyeBrow(Point(70, 60), Point(90, 80));
	headt->SetLeftEyeBrow(Point(40, 60), Point(20, 80));
